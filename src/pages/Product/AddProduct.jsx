const AddProduct =()=>{
    return(
        <div className="modal fade zindex-2" id="add_product_modal" tabindex="-1" aria-hidden="true">
                ...
                <div className="modal-body">
                    <div className="container">
                        <div className="row justify-content-center">
                            ...
                            <div className="col-12 col-md-6 col-lg-8">
                                <div className="input-group mb-3dir_ltr">
                            ...
                            <div className="col-12 col-md-6 col-lg-8">
                                <div className="input-group mb-3dir_ltr">
                                    ...
                                    <input type="text" className="form-control" placeholder="قسمتی از نام برند را وارد کنید"
                                        list="brandLists"/>
                            ...
                            <div className="col-12 col-md-6 col-lg-8">
                                <div className="input-group mb-2dir_ltr">
                                    <input type="text" className="form-control" placeholder="قسمتی از نام رنگ را وارد کنید"
                                        list="colorList"/>
                            ...
                            <div className="col-12 col-md-6 col-lg-8">
                                <div className="input-group mb-3dir_ltr">
                                    <textarea type="text" className="form-control" placeholder="توضیحات"
                                        rows="5"></textarea>
                            ...
                            <div className="col-12 col-md-6 col-lg-8 row justify-content-center">
                                <div className="form-check form-switch col-5 col-md-2">
                                    <input className="form-check-input pointer" type="checkbox" id="flexSwitchCheckDefault"
                                        checked />
                                    <label className="form-check-label pointer" for="flexSwitchCheckDefault">وضعیت
                                        فعال</label>
                                </div>
                            </div>
